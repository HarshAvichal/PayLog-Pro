      ...
      <div className="p-6 border-b border-gray-200">
        <div className="mb-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-semibold text-gray-900">All Pay Periods</h2>
            <button
              onClick={() => setShowFilters(!showFilters)}
              className="px-3 py-1 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition flex items-center gap-2"
            >
              {showFilters ? (
                <>
          ...
          <div className="flex gap-2 items-center">
            ...
            >
              {showWithDeductions ? '✓ ' : ''}With Deductions
            </button>
            <button
              onClick={() => {
                setShowLatest(false);
            ...
            >
              {showNoDeductions ? '✓ ' : ''}No Deductions
            </button>
            <button
              onClick={() => {
                setShowWithDeductions(false);
            ...
            {(showWithDeductions || showNoDeductions || showLatest || dateFilter !== 'all' || minAmount || maxAmount || searchQuery) && (
              <button
                ...
                className="px-3 py-1 text-sm font-medium rounded-lg bg-gray-200 text-gray-700 hover:bg-gray-300 transition ml-2"
              >
                Clear All
              </button>
            )}
      ...
      <div className="overflow-x-auto border-t border-gray-300">
        <table className="w-full">
          <thead className="bg-[#2C475E]">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wide">Period</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wide">Hours</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wide">Expected</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wide">Actual</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wide">Actions</th>
            </tr>
          </thead>
          <tbody>
            {filteredPayPeriods.length === 0 ? (
              ...
              filteredPayPeriods.map((pp, index) => {
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-[#333333] border-b border-gray-100">
                    <Link
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm border-b border-gray-100">
                    {pp.actual_pay ? (
