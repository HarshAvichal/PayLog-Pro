    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Pay Period Details</h1>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg border border-white/20 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-sm text-gray-600 mb-1">Expected Pay</p>
              <p className="text-2xl font-bold text-gray-900">
                ${payPeriod.expected_pay?.toFixed(2) || '0.00'}
              </p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-sm text-gray-600 mb-1">Actual Pay</p>
              <p className="text-2xl font-bold text-gray-900">
          ...
          {payPeriod.notes && (
            <div className="mb-6">
              ...
              <p className="text-gray-900 bg-gray-50 p-3 rounded-lg">{payPeriod.notes}</p>
            </div>
          )}
                      ...
                      shifts.map((shift, index) => {
                        ...
                        return (
                          <tr key={shift.id} className={`${rowBgColor} hover:bg-opacity-80 transition-colors`}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-[#333333] border-b border-gray-100">{shift.time_in}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-[#333333] border-b border-gray-100">{shift.time_out}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-[#333333] border-b border-gray-100">{shift.department || '-'}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-[#333333] border-b border-gray-100">{shift.hours.toFixed(2)}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-[#333333] border-b border-gray-100">
